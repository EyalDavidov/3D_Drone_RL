...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="C:\\Isaac\\Projects\\first_drone\\data\\depth_collection",
    ...
    parser.add_argument("--save_dir", type=str, default="C:\\Isaac\\Projects\\first_drone\\logs\\vae",
