...
# We mock isaaclab so it doesn't crash if imported transitively? No, VAE itself doesn't import isaaclab.
# Ah, test_vae.py crashed because `from first_drone.models.vae import VAE` imported `first_drone.__init__` which imports `first_drone.tasks`.
