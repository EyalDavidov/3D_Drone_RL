...
class SACDroneEnvCfg(DirectRLEnvCfg):
    ...
    # BARE MINIMUM REWARDS FOR DEBUGGING
    w_progress: float = 3.0       # Provide clear positive gradient towards goal
    w_goal: float = 100.0          # Strong terminal reward for reaching goal
    collision_penalty: float = -100.0 # Terminal penalty for crashing
    w_heading: float = 0.5        # Keep gazing at the goal
    w_ang_vel: float = 0.0#-0.05      # Discourage constant spinning out of control
    goal_radius: float = 0.40
    pillar_collision_radius: float = 0.15
    # =========================================================================
