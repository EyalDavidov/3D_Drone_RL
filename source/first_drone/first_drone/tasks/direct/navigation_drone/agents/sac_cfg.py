...
class SACAgentCfg:
    ...
    sac_update_every: int = 1        # update SAC every env step (was 4 — too infrequent with 64 envs)
    
    # Dynamic gradient steps schedule (decays linearly as training progresses)
    sac_gradient_steps_start: int = 20
    sac_gradient_steps_end: int = 1
